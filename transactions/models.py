...
class Transaction(models.Model):
    ...
    sender_id           = models.ForeignKey(Account, blank=True, null=True, on_delete=models.SET_NULL, related_name='Nadawca')
    reciver_id          = models.ForeignKey(Account, null=True, on_delete=models.SET_NULL, related_name='Odbiorca')
